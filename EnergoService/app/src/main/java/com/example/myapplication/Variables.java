...
public class Variables {
    ...
    static String[] typesOfRoomsDetSad = { "Игровая","Гардероб", "Спальная", "Санузел", "Коридор", "Тамбур","Лестница","Кабинет","Пищеблок","Прачечная","Моечная","Кладовая","Служебное помещение","Спортзал","Актовый зал","Медкабинет","Другое"};            //Типы помещений(детские сады)
    static String[] typesOfRoomsSchools = { "Учебный кабинет", "Кабинет", "Санузел", "Коридор", "Тамбур","Лестница","Спортзал","Пищеблок","Актовый зал","Медкабинет","Столовая","Кладовая","Служебное помещение","Другое"};            //Типы помещений(школы)
    static String[] typesOfRoomsHospitals = { "Кабинет врача", "Кабинет", "Санузел", "Коридор", "Тамбур","Лестница","Спортзал","Пищеблок","Актовый зал","Медкабинет","Кладовая","Столовая","Служебное помещение","Палата","Процедурная","Другое"};            //Типы помещений(больницы)
    static String[] typesOfRoomsOthers = { "Коридор", "Кабинет", "Санузел", "Служебное помещение", "Тамбур","Лестница","Спортзал","Пищеблок","Актовый зал","Медкабинет","Кладовая","Служебное помещение","Столовая","Другое"};            //Типы помещений(больницы)
    ...
    public static final String[] lampDiodsNames = {             //Названия светодиодных светильников
            "4*9Вт","4*9Вт","2*18Вт","2*9Вт","12Вт","12Вт","12Вт","4*10Вт","4*10Вт","2*20Вт","10Вт","15Вт"
    };
