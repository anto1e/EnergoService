...
public class Variables {
    ...
    static String[] typesOfRoomsDetSad = {"Служебное помещение","Актовый зал","Вестибюль","Гардероб","Групповая","ГРЩ","Кабинет", "Коридор","Кладовая","Лаборантская","Лестница","Моечная","Медкабинет","Музыкальный зал","Пищеблок","Прачечная","Подсобное помещение","Раздевалка","Спальная", "Санузел","Спортзал",  "Тамбур","Умывальная","Техническое помещение","Другое"};            //Типы помещений(детские сады)
    ...
    static String[] typesOfRoomsSchools = {"Служебное помещение","Актовый зал","Бассейн","Библиотека","Вестибюль","Гардероб","ГРЩ","Учебный кабинет", "Кабинет", "Коридор","Кладовая","Лаборантская","Лестница", "Моечная","Санузел", "Медкабинет","Пищеблок","Подсобное помещение","Раздевалка","Столовая","Спортзал","Тамбур","Умывальная","Техническое помещение","Другое"};            //Типы помещений(школы)
    ...
    static String[] typesOfRoomsHospitals = {"Служебное помещение","Актовый зал","Бассейн","Вестибюль","Гардероб","ГРЩ","Душевая","Кабинет врача", "Кабинет", "Санузел", "Коридор","Кладовая","Лестница", "Медкабинет","Моечная","Палата","Пищеблок","Процедурная","Подсобное помещение","Операционная","Спортзал","Столовая","Тамбур","Умывальная","Другое"};            //Типы помещений(больницы)
